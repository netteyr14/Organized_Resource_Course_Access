...
$errors = [];
$input  = ['username' => '', 'email' => '', 'role' => 'professor'];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $stmt->execute([$input['username'], $input['email'], $hashed, $input['role']]);
  ...
  <div class="page-wrap">
    ...
    <div class="form-card">
      ...
      <form method="POST" action="add.php" novalidate>
        ...
        <p class="hint" style="margin-top:-.75rem; margin-bottom:1rem;">Password is stored securely using bcrypt hashing.</p>
